		...
		<div class="container flex-grow-1 pt-6">
			<div class="row h-100 align-items-center justify-content-center py-5 py-lg-6">
				<div class="col-sm-10 col-md-8 col-lg-6 col-xl-5">
					...
					<form class="card shadow needs-validation" :class="{'was-validated': form.hasValidationErrors}" @submit.prevent="signup(true, true)" autocomplete="off" novalidate>
						<div class="card-body p-4">
							...
							<small class="text-muted text-center">
								<p class="mb-0">
									I already have a account — <a href="/login" class="btn btn-sm btn-link align-baseline p-0">Login</a>
								</p>
								<p class="mb-0">
