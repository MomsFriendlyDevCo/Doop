...
!function ($) {
    ...
    LeftSidebar.prototype.initMenu = function() {
        console.log('LeftSidebar.initMenu');
        var self = this;
        ...
        // Left menu collapse
        console.log('.button-menu-mobile el', $('.button-menu-mobile').get());
        $('.button-menu-mobile').on('click', function (event) {
            console.log('.button-menu-mobile click', event);
        ...
        //console.log('events', $._data( $('.button-menu-mobile').get(0), "events" ));
   ...
   RightBar.prototype.selectOptionsFromConfig = function() {
    ...
    RightBar.prototype.init = function() {
        ...
        $(document).on('click', '.right-bar-toggle', function () {
            //console.log('.button-menu-mobile el', $('.button-menu-mobile').get(0));
...
// FIXME: Initialise Waves before now.
// Waves Effect
//Waves.init();